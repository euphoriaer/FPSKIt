...
namespace MarsFPSKit
{
    namespace Weapons
    {
        public abstract class WeaponRuntimeDataBase
        {
        ...
        public abstract class Kit_WeaponBase : ScriptableObject
        {
            ...
            /// </summary>
            /// <returns></returns>
            public virtual bool WaitForQuickUseButtonRelease(Kit_PlayerBehaviour pb, object runtimeData)
            {
                return true;
            }
            ...
            /// <param name="pb"></param>
            /// <param name="isThirdPersonEnabled"></param>
            public virtual void OnTriggerEnterRelay(Kit_PlayerBehaviour pb, object runtimeData, Collider col) { }
            ...
            /// <param name="pb"></param>
            /// <param name="isThirdPersonEnabled"></param>
            public virtual void OnTriggerExitRelay(Kit_PlayerBehaviour pb, object runtimeData, Collider col) { }
            #endregion
            ...
            /// <param name="runtimeData"></param>
            /// <returns></returns>
            public virtual bool IsWeaponAiming(Kit_PlayerBehaviour pb, object runtimeData)
            {
                return false;
            }

            public virtual float GetAimingPercentage(Kit_PlayerBehaviour pb, object runtimeData)
            {
                return 0f;
            }
