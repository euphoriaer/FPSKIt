...
namespace MarsFPSKit
{
    ...
    public class Kit_SimpleImpactProcessor : Kit_ImpactParticleProcessor
    {
        ...
        public override void StartImpactProcessor(Kit_IngameMain main)
        {
        ...
        public override void ProcessImpact(Kit_IngameMain main, Vector3 pos, Vector3 normal, string materialType, Transform parent = null)
        {
