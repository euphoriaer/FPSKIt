...
namespace MarsFPSKit
{
    ...
    public abstract class Kit_KillFeedBase : MonoBehaviour
    {
        ...
        public abstract void Append(bool botKiller, int killer, bool botKilled, int killed, int gun, int playerModel, int ragdollId);
        ...
        /// <param name="killed">Who was killed</param>
        /// <param name="gun">Which weapon was used to kill</param>
        public abstract void Append(bool botKiller, int killer, bool botKilled, int killed, string cause, int playerModel, int ragdollId);
    }
}
