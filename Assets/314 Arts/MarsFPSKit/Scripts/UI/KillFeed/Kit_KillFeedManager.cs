...
namespace MarsFPSKit
{
    public class Kit_KillFeedManager : Kit_KillFeedBase
    {
        ...
        public override void Append(bool botKiller, int killer, bool botKilled, int killed, int gun, int playerModel, int ragdollId)
        {
        ...
        /// <param name="killed">Who was killed</param>
        /// <param name="gun">Which weapon was used to kill</param>
        public override void Append(bool botKiller, int killer, bool botKilled, int killed, string cause, int playerModel, int ragdollId)
        {
            GameObject go = Instantiate(killFeedPrefab, killFeedGo, false);
            //Reset scale
            go.transform.localScale = Vector3.one;
